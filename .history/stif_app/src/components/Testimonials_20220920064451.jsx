    ...
    <section id="clients" className={`${styles.paddingY}
      ${styles.flexCenter} flex-col relative`}>
        ...
        <div className="w-full flex justify-between items-center
          ...
          <h1 className={`${styles.heading2} text-gold-gradient`}>
            What people are <br className="sm:block hidden" /> saying about us
          </h1>
          <div className="w-full md:mt-0 mt-6">
            <p className={`${styles.paragraph} text-left max-w-[450px]`}>
              Everything you need to make profits trading the financial
              markets anywhere around the world.
            </p>
          </div>
        </div>
        
        <div className="flex flex-wrap sm:justify-start justify-center
              w-full feedback-container text-dimWhite relative z-[1]">
          {feedback.map((card) => (
